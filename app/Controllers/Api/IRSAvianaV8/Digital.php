...
class Digital extends MyResourceDigipos
{
    public function getDigital($mssidn, $paymentMethod)
    {
        $response = $this->digiposApi->getProduct($mssidn, $paymentMethod, 'digital');
