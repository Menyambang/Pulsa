...
$(document).ready(function() {
    jQuery('.sidebar-submenu li a.active').parent().parent().parent().find('a.sidebar-link').addClass('active').trigger('click');
});

jQuery('.sidebar-submenu li a.active').parent().find('.sidebar-link').addClass('active');
